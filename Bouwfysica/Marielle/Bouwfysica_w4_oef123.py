...
gekozen_set3 = random.choice(lijst)
while gekozen_set3 == gekozen_set1 or gekozen_set3 == gekozen_set2:
    gekozen_set3 = random.choice(lijst)

c_max3 = gekozen_set3['c']
temp3 =gekozen_set3['t']
RV3 = kies_integer_getal_stap(50,90,10)
c_lucht3 = round(c_max3 * RV3 / 100, 2)

print([c_max1,temp1,RV1,c_lucht1,c_max2,temp2,RV2,c_lucht2,c_max3,temp3,RV3,c_lucht3])
