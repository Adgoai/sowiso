...
# Sloot: waterdiepte d = 3,98 m, bodembreedte w = 4,35 m, talud rechts is 1 : 4. Talud links verticaal
...
oppervlakte = bodembreedte * waterdiepte + 0.5 * talud * waterdiepte * waterdiepte
# print(oppervlakte)
natteomtrek = bodembreedte + waterdiepte + (waterdiepte ** 2 + (waterdiepte * talud) ** 2 ) ** 0.5
# print(natteomtrek)

# Vraag 14 Bereken de hydraulische straal in m
